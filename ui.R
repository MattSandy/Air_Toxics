...
shinyUI(fluidPage(
    ...
    fluidRow(
        column(2,
               ...
               img(src="https://cloud.githubusercontent.com/assets/6283030/4280095/0091e9c4-3d29-11e4-9daf-3d935c60a380.png", style = "margin:auto; margin-top:10px; padding-top:10px; width:108%; height:180px; max-width:200px; max-height:190px; ")
        ),
